...
5.  Kanit (2026-09-14): `tests/ai` 128 passed, tam suite 147 passed; migration head `f5a13c9d7e21`; commit araligi `5e50db1..5e29bc3` (HEAD `5e29bc3`); disposable SQLite DB'de `upgrade/current/check` PASS, cleanup tamamlandi.
